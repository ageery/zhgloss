...
public class JsonbArrayAttrValuesToArr extends AbstractRoutine<String[]> {

	private static final long serialVersionUID = 1615254173;

	/**
	 * The parameter <code>public.jsonb_array_attr_values_to_arr.RETURN_VALUE</code>.
	 */
	...
	/**
	 * The parameter <code>public.jsonb_array_attr_values_to_arr.jsonb_arr</code>.
	 */
	...
	/**
	 * The parameter <code>public.jsonb_array_attr_values_to_arr.attr_name</code>.
	 */
	 ...
	 */
	public JsonbArrayAttrValuesToArr() {
		super("jsonb_array_attr_values_to_arr", Public.PUBLIC, org.jooq.impl.SQLDataType.CLOB.getArrayDataType());
