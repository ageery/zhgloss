...
public class Keys {
	...
	private static class ForeignKeys0 extends AbstractKeys {
		public static final ForeignKey<CedictWordDefRecord, CedictWordRecord> CEDICT_WORD_DEF__CEDICT_WORD_DEF_WORD_ID_FKEY = createForeignKey(com.zhgloss.repo.jooq.Keys.CEDICT_WORD_PKEY, CedictWordDef.CEDICT_WORD_DEF, CedictWordDef.CEDICT_WORD_DEF.WORD_ID);
		public static final ForeignKey<TranscriptionPointRecord, TranscriptionSystemRecord> TRANSCRIPTION_POINT__TRANSCRIPTION_POINT_TS_CODE_FKEY = createForeignKey(com.zhgloss.repo.jooq.Keys.TRANSCRIPTION_SYSTEM_PKEY, TranscriptionPoint.TRANSCRIPTION_POINT, TranscriptionPoint.TRANSCRIPTION_POINT.TS_CODE);
		public static final ForeignKey<WordDefRecord, WordRecord> WORD_DEF__WORD_DEF_WORD_ID_FKEY = createForeignKey(com.zhgloss.repo.jooq.Keys.WORD_PKEY, WordDef.WORD_DEF, WordDef.WORD_DEF.WORD_ID);
	}
}
